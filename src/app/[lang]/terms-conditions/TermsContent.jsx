    ...
    <div className="ptb-100">
      <div className="container">
        <div className="main-content-text">
          <p>
            <i>This Terms & Conditions was last updated on January 1, 2022.</i>
          </p>
          ...
          <blockquote className="blockquote">
            <p>
              ...
              from third-party platforms you connect with Edmy. We also collect
              some data automatically, like information about your device and
          ...
          <ul>
            ...
            <li>
              ...
              other types of local data storage. Your wireless device may also
              allow you to control whether location or other data is collected
              and shared. You can manage Adobe LSOs through their Website
            ...
            <li>
              ...
              Advertising Alliance, or if you are located in the European Union,
              visit the Your Online Choices site. To opt out of Google display
              advertising or customize Google Display Network ads, visit the
              Google Ads Settings page. To opt out of Taboola targeted ads, see
              the Opt-out Link in their Cookie Policy.
            </li>
            <li>
          ...
          <p>
            ...
            European Economic Area) should not use the Services. If we learn
            that we have collected personal data from a child under those ages,
